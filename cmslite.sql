...
INSERT INTO `product` VALUES (1,'\0','2019-04-09 08:45:57.915','CH11-AL001','Office desk grommet ','80/160/274*80','','/resources/20190412/43290083477946369.jpg',42932227876585473),(2,'\0','2019-04-09 08:47:55.115','CH11-PVC006','Office desk grommet ','50/53/60/80','','/resources/20190412/43290665446014977.jpg',42932227876585473),(3,'\0','2019-04-09 08:50:18.466','CH11-AL011-012','Office desk grommet ','200/250/300*130','','/resources/20190412/43290861940768769.jpg',42932227876585473),(4,'\0','2019-04-09 08:52:34.721','CH11-AL013-014','Office desk grommet ','200/250/300*130','','/resources/20190412/43291047698104321.jpg',42932227876585473),(5,'\0','2019-04-09 08:53:43.102','CH11-AL015','Office desk grommet ','300/400/500*110','','/resources/20190412/43291316133560321.jpg',42932227876585473),(6,'\0','2019-04-09 08:55:19.154','CH11-AL016','Office desk grommet ','292/392/492*135','','/resources/20190412/43291500817154049.jpg',42932227876585473),(7,'\0','2019-04-09 08:57:14.105','CH10-PVC014','Screen clamp ','16-18MM','','/resources/20190412/43292171905794049.jpg',42932241835229185),(8,'\0','2019-04-09 08:58:17.540','CH10-AL015','Screen clamp ','16-18mm','','/resources/20190412/43292219150434305.jpg',42932241835229185),(9,'\0','2019-04-09 08:59:13.349','CH10-AL016','Screen clamp','16-18MM','','/resources/20190412/43292255657656321.jpg',42932241835229185),(10,'\0','2019-04-09 09:00:22.227','CH10-AL017','Screen clamp ','16-18MM','','/resources/20190412/43292296459845633.jpg',42932241835229185),(11,'\0','2019-04-09 09:01:47.649','CH10-ABS041','Spring tube','55*300MM','','/resources/20190412/43292880575397889.jpg',42932241835229185),(12,'\0','2019-04-09 09:02:44.873','CH10-ABS042','Wire collection tube ','750*65*35MM','','/resources/20190412/43292995465773057.jpg',42932241835229185),(13,'\0','2019-04-09 09:03:40.608','CH10-ABS045','Wire collection tube ','750*65*45','','/resources/20190412/43292951442358273.jpg',42932241835229185),(14,'\0','2019-04-09 09:04:32.124','CH10-ABS046','Wire collection tube ','750*60','','/resources/20190412/43293329399480321.jpg',42932241835229185),(15,'\0','2019-04-09 09:06:22.088','CH10-PVC013','Office desk mat ','680-700*400-450','','/resources/20190412/43293502271913985.jpg',42932241835229185),(16,'\0','2019-04-09 09:08:19.221','CH5-SS014','Kitchen cabinet basket ','865*495*(650-750)','','/resources/20190412/43293668701896705.jpg',42931454782472193),(17,'\0','2019-04-09 09:10:16.549','CH6-PVC001','Kitchen waste bin ','480*342*418','','/resources/20190412/43293972570832897.jpg',42931557861687297),(18,'\0','2019-04-09 09:11:38.303','CH6-PVC002','Kitchen waste bin','480*342*418','','/resources/20190412/43294013373022209.jpg',42931557861687297),(19,'\0','2019-04-09 09:12:52.717','CH6-PVC005','Kitchen waste bin ','480*260*418','','/resources/20190412/43294044511535105.jpg',42931557861687297),(20,'\0','2019-04-09 09:14:28.147','CH6-SS008','Kitchen waste bin ','8L','','/resources/20190412/43294258186158081.jpg',42931557861687297),(21,'\0','2019-04-09 09:16:23.283','CH7-ABS013','Cutlery tray ','560-630*420-500*50','','/resources/20190412/43294396698853377.jpg',42931483773501441),(22,'\0','2019-04-09 09:17:45.547','CH7-SS00140','Cutlery tray ','280*372/422/472*64','','/resources/20190412/43294729558818817.jpg',42931483773501441),(23,'\0','2019-04-09 09:19:23.585','CH8-EVA','Anti-slip mat','400gsw-1000','','/resources/20190412/43294764992299009.jpg',42931498805886977),(24,'\0','2019-04-09 09:20:40.010','CH8-PO','Anti-slip mat','400-1000gsw','','/resources/20190412/43294798278295553.jpg',42931498805886977);
...
--
-- Table structure for table `translate_field`
--
...
CREATE TABLE `translate_field` (
  `id` bigint(11) unsigned NOT NULL DEFAULT '0' COMMENT '翻译ID',
  `del` bit(1) NOT NULL DEFAULT b'0' COMMENT '已删除',
  `add_time` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '添加时间',
  `referer_id` bigint(11) unsigned NOT NULL DEFAULT '0' COMMENT '关联ID',
  `content` varchar(2000) NOT NULL DEFAULT '' COMMENT '字段翻译',
...
--
-- Dumping data for table `translate_field`
--

LOCK TABLES `translate_field` WRITE;
/*!40000 ALTER TABLE `translate_field` DISABLE KEYS */;
/*!40000 ALTER TABLE `translate_field` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `translate_search`
--

DROP TABLE IF EXISTS `translate_search`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `translate_search` (
  `id` bigint(11) unsigned NOT NULL DEFAULT '0' COMMENT '翻译ID',
  `del` bit(1) NOT NULL DEFAULT b'0' COMMENT '已删除',
  `add_time` timestamp(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '添加时间',
  `referer_id` bigint(11) unsigned NOT NULL DEFAULT '0' COMMENT '关联ID',
  `field` varchar(30) NOT NULL DEFAULT '' COMMENT '字段名',
  `content` varchar(300) NOT NULL DEFAULT '' COMMENT '字段翻译',
  `type` varchar(30) NOT NULL DEFAULT '' COMMENT '表名',
  `language` varchar(10) NOT NULL DEFAULT '' COMMENT '国际locale',
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `translate_search`
--

LOCK TABLES `translate_search` WRITE;
/*!40000 ALTER TABLE `translate_search` DISABLE KEYS */;
/*!40000 ALTER TABLE `translate_search` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `translate_text`
--
...
CREATE TABLE `translate_text` (
  ...
  `referer_id` bigint(11) unsigned NOT NULL DEFAULT '0' COMMENT '关联ID',
  `field` varchar(30) NOT NULL DEFAULT '' COMMENT '字段名',
  `content` text NOT NULL COMMENT '字段翻译',
  `type` varchar(30) NOT NULL DEFAULT '' COMMENT '表名',
  `language` varchar(10) NOT NULL DEFAULT '' COMMENT '国际locale',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_referer` (`referer_id`,`field`,`type`,`language`)
...
--
-- Dumping data for table `translate_text`
--

LOCK TABLES `translate_text` WRITE;
/*!40000 ALTER TABLE `translate_text` DISABLE KEYS */;
/*!40000 ALTER TABLE `translate_text` ENABLE KEYS */;
UNLOCK TABLES;
